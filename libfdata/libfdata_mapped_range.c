...
/* Retrieves the mapped range flags
 * Returns 1 if successful or -1 on error
 */
int libfdata_mapped_range_get_flags(
     ...
     libcerror_error_t **error )
{
	static char *function = "libfdata_mapped_range_get_flags";
	...
	*flags = mapped_range->flags;

	return( 1 );
}

/* Sets the mapped range flags
 * Returns 1 if successful or -1 on error
 */
int libfdata_mapped_range_set_flags(
     ...
     libcerror_error_t **error )
{
	static char *function = "libfdata_mapped_range_set_flags";
