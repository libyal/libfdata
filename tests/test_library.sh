...
LIBRARY_TESTS="area cache error list list_element mapped_range notify range range_list stream support vector";
...
run_test()
{
	...
	local TEST_EXECUTABLE="./fdata_test_${TEST_NAME}";
...
run_test_with_input()
{
	...
	local TEST_PROFILE_DIRECTORY=$(get_test_profile_directory "input" "libfdata");
